...
const {doorlock} = require('./devices/doorlock');
const {thermostat} = require('./devices/thermostat');
const {contactsensor} = require('./devices/contactsensor');
const {colortemplight} = require('./devices/colortemplight');
const {fullcolorlight} = require('./devices/fullcolorlight');
const {dimmablelight} = require('./devices/dimmablelight');
const {onoffsocket} = require('./devices/onoffsocket');
const {onofflight} = require('./devices/onofflight');
const {lightsensor} = require('./devices/lightsensor');
const {genericswitch} = require('./devices/genericswitch');
const {windowcovering} = require('./devices/windowcovering');
const {humiditysensor} = require('./devices/humiditysensor');
const {pressuresensor} = require('./devices/pressuresensor');
const {occupancysensor} = require('./devices/occupancysensor');
const {temperaturesensor} = require('./devices/temperaturesensor');
